...
export default function StatsList() {
    ...
    const getStat = (type) => {
        if (type === 'PvP' || type === 'PvE') {
            return {
                GP: currentUser.stats[type].W + currentUser.stats[type].D + currentUser.stats[type].L,
                W: currentUser.stats[type].W,
                D: currentUser.stats[type].D,
                L: currentUser.stats[type].L
            }
        }
        if (type === 'total') {
            return {
                GP: currentUser.stats.PvP.W + currentUser.stats.PvP.D + currentUser.stats.PvP.L + currentUser.stats.PvE.W + currentUser.stats.PvE.D + currentUser.stats.PvE.L,
                W: currentUser.stats.PvP.W + currentUser.stats.PvE.W,
                D: currentUser.stats.PvP.D + currentUser.stats.PvE.D,
                L: currentUser.stats.PvP.L + currentUser.stats.PvE.L
            }
        }
        return {
            GP: 0,
